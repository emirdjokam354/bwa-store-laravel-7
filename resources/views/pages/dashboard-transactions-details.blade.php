                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <img src="{{ Storage::url($transaction->product->galleries->first()->photos ?? '') }}" class="w-100 mb-2" alt="">
                                    </div>
                                ...
                                <form action="{{ route('dashboard-transaction-update', $transaction->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="product-subtitle">{{ App\Models\Province::findOrFail($transaction->transaction->user->provinces_id)->name }}</div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="product-title">City</div>
                                                    <div class="product-subtitle">{{ App\Models\Regency::findOrFail($transaction->transaction->user->regencies_id)->name }}</div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                ...
                                                <template v-if="status == 'SHIPPING'">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" name="resi" class="form-control" id=""
                                                            v-model="resi">
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            ...
                                            <a href="{{ route('dashboard-transaction') }}" class="btn btn-secondary btn-lg mt-4">
                                                Kembali
                                            </a>
                                        </div>
                                    </div>
