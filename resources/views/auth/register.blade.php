                    ...
                    <div class="col-lg-4">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" v-model="name" class="form-control @error('name') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" v-model="email" @change="checkForEmailAvailability()"
                                    class="form-control @error('email') is-invalid @enderror" :class="{ 'is-invalid' : this.email_unavailable}"
                            ...
                            <button type="submit" class="btn btn-success btn-block" :disabled="this.email_unavailable">
                                Sign Up Now
                            </button>
