                ...
                <div class="row">
                    <div class="col-lg-8" data-aos="zoom-in">
                        <transition name="slide-fade" mode="out-in">
                            <img class="w-100 main-image" :src="photos[activePhoto].url" :key="photos[activePhoto].id"
                                alt="">
                            ...
                            <div class="col-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo,index) in photos" :key="photo.id"
                                ...
                                <a href="#" @click="changeActive(index)">
                                    <img :src="photo.url" class="w-100 thumbnail-image"
                                        :class="{ active: index == activePhoto}" alt="" srcset="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <img src="/images/img-review-1.png" class="rounded-circle mr-3" alt="">
                                    ...
                                    <li class="media">
                                        <img src="/images/img-review-2.png" class="rounded-circle mr-3" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img src="/images/img-review-3.png" class="rounded-circle mr-3" alt="">
                                        <div class="media-body">
